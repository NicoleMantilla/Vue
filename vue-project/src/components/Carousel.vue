      ...
      <div id="heroControls" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="img-fluid" src="@/assets/1.jpeg" alt="First slide">
          </div>
          <div class="carousel-item">
            <img class="img-fluid" src="@/assets/2.jpeg" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img class="img-fluid" src="@/assets/3.jpeg" alt="Third slide">
          </div>
        </div>
      </div>
    </section>
